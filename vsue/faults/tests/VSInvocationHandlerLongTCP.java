...
import vsue.faults.RequestMessage;
...
public class VSInvocationHandlerLongTCP implements InvocationHandler,Serializable {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        VSRequestID requestID = new VSRequestID(
        "test-" + System.currentTimeMillis(),
        0
    );
        RequestMessage request = new RequestMessage(method.getName(), args, remoteReference.getObjectId(),requestID);     
